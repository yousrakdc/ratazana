...
DATABASES = {
    'default': {
        ...
        'NAME': 'ratazana_db',  # Replace with your database name
        'USER': 'ratazana',  # Replace with your PostgreSQL username
        'PASSWORD': 'eminem31',  # Replace with your PostgreSQL password
